...
const Dropdown = () => {
  ...
  return (
    <div className="dropdown relative">
      ...
      {/* sidebar starts here  */}
      <section className={`absolute -top-2 -left-2 bg-gray-200 w-[100vw] md:w-72 h-[100vh] border py-2 px-6 transition-transform ${toggle} z-20`}>
        <AiOutlineClose onClick={handleToggle} className="absolute right-6 md:right-2 text-2xl text-gray-400 rounded-full hover:bg-gray-300 cursor-pointer"/>
